...
load data from stage tables into fact table is part of ETL method
for transfer data  
'''
class LoadFactOperator(BaseOperator):
    ...
    def execute(self, context): 
        ...
        self.log.info(f'start Tha fact table {self.table} is  loaded data ')
        ...
        self.log.info(f'Tha fact table {self.table} is  loaded data ')